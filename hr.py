...
class hr_employee(osv.osv):
    ...
    _columns = {
        ...
        # Added for getting the <Calle> field
        'calle_numero':fields.char('Calle y Número'),
        # If the field <Entre las calles> is necessary added it here:

        # Added the <Colonia> field
        'colonia':fields.char('Colonia'),
        # If the field <Población> is necessary added it here:

        # Added the <Municipio> field
        'municipio':fields.char('Municipio/del'),
        # Added the <C.P.> field
        'cod_postal':fields.integer(string='C.P.', size=10),
        ...
        'extension1':fields.integer(string="Extensión 1", size=10),
        'extension2':fields.integer(string="Extensión 2", size=10),
        # Added the <Otros> field
        'address_home_id': fields.many2one('res.partner', 'Home Address'),
        'bank_account_id': fields.many2one('res.partner.bank', 'Bank Account Number', domain="[('partner_id','=',address_home_id)]", help="Employee bank salary account"),
        # Taking this defined field has the <Telefono de oficina> field
        'work_phone': fields.char('Teléfono oficina', readonly=False),
        'mobile_phone': fields.char('Tel. celular', readonly=False),
        # Taking this defined field has the <Email> field
